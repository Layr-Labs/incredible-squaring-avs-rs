...
async fn main() {
    ...
    let config: OperatorConfig = load_config("./src/config/squaring-operator-2.toml").unwrap();
    ...
    let logic = failing_response_calculator(response_calculator, || U256::from(42), 70);
