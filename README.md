...
- Aggregator: use the `aggregator` provided by [eigensdk](https://github.com/Layr-Labs/eigensdk-rs). Implement the `TaskProcessor` and `TaskResponse` traits, and initialize and start the aggregator.
