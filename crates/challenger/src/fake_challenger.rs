...
use alloy::{
    hex::FromHex,
    primitives::TxHash,
    rpc::types::{serde_helpers::OtherFields, AccessList, Transaction, TransactionReceipt},
};
use alloy_provider::Provider;
use eigen_utils::get_provider;
use incredible_bindings::IncredibleSquaringTaskManager::{
    respondToTaskCall, G1Point, G2Point, Task, TaskResponded,
};
...
impl FakeChallenger {
    /// Raise challenge
    pub async fn raise_challenge(&self, task_index: u32) -> Result<TxHash, ChallengerError> {
