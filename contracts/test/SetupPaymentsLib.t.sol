...
import {IncredibleSquaringServiceManagerSetup} from "test/IncredibleSquaringServiceManager.t.sol";
import {
    Quorum,
    StrategyParams,
    IStrategy
...
contract SetupPaymentsLibTest is Test, TestConstants, IncredibleSquaringServiceManagerSetup {
