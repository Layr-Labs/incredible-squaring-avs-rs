...
contract IncredibleSquaringDeployer is Script {
    ...
    function run() external {
        ...
        FundOperator.fund_operator(address(erc20Mock), isConfig.operator_addr, 5000e18);
        FundOperator.fund_operator(address(erc20Mock), isConfig.operator_2_addr, 7000e18);
